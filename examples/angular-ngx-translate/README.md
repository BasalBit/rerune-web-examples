...
This app pins Angular **18.2.14**, TypeScript **5.5.4**, and ngx-translate 18.0.0 and ngx-translate-messageformat-compiler 7.3.0. The Angular build cache is disabled. Builds were verified in CI mode; cache-enabled LMDB operation is not claimed to be fixed.
